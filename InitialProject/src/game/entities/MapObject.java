...
public abstract class MapObject {
	...
	public boolean notOnScreen(){
		...
		private void calculateYMovement(){
			calculateYUpperMovement();
			calculateYDownwardMovement();
		}

		private void calculateYDownwardMovement() {
		...
		private void calculateYUpperMovement() {
		...
		private void calculateXMovement(){			
			calculateXLeftMovement();
			calculateXRightMovement();
		}

		private void calculateXRightMovement() {
		...
		private void calculateXLeftMovement() {
			if(this.position.getDirectionX() < 0){
